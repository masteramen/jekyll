...
### shiro-first.ini
  ...
  [http://propedit.sourceforge.jp/eclipse/updates/](http://www.jfox.info/go.php?url=http://propedit.sourceforge.jp/eclipse/updates/)![](08f2581.png)在MyEclipse配置后，在classpath创建shiro.ini配置文件，为了方便测试将用户名和密码配置在shiro-first.ini文件中
    #对用户信息进行配置
    [users]
    #用户账号和密码
    zhangsan=123456
